...
**File -  `1-for_best_school`:** Write a Bash script that displays  `Best School`  10 times.
...
**File -  `2-while_best_school`:** Write a Bash script that displays  `Best School`  10 times.
...
**File - `3-until_best_school`:** Write a Bash script that displays  `Best School`  10 times.
...
**File -  `4-if_9_say_hi`:** Write a Bash script that displays  `Best School`  10 times, but for the 9th iteration, displays  `Best School`  _and then_  `Hi`  on a new line.
...
**File -  `5-4_bad_luck_8_is_your_chance`:** Write a Bash script that loops from 1 to 10 and:
...
**File-  `6-superstitious_numbers`:** Write a Bash script that displays numbers from 1 to 20 and:
...
**File -  `7-clock`:** Write a Bash script that displays the time for 12 hours and 59 minutes:
...
**File - `8-for_ls`:** Write a Bash script that displays:
...
**File -  `9-to_file_or_not_to_file`:** Write a Bash script that gives you information about the  `school`  file.
...
**File -  `10-fizzbuzz`:** Write a Bash script that displays numbers from 1 to 100.
