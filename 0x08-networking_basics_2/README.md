...
**File - `0-change_your_home_IP`:** Write a Bash script that configures an Ubuntu server with the below requirements.
...
**File - `100-port_listening_on_localhost`:** Write a Bash script that listens on port  `98`  on  `localhost`.
