...
**File -  `0-what-is-my-pid`:** Write a Bash script that displays its own PID.
...
**File -  `1-list_your_processes`:** Write a Bash script that displays a list of currently running processes.
...
**File -  `4-to_infinity_and_beyond`:** Write a Bash script that displays  `To infinity and beyond`  indefinitely.
...
**File -  `6-stop_me_if_you_can`:** Write a Bash script that stops  `4-to_infinity_and_beyond`  process.
...
**File -  `7-highlander`:** Write a Bash script that displays:
...
**File -  `8-beheaded_process`:** Write a Bash script that kills the process  `7-highlander`.
...
**File -  `100-process_and_pid_file`:** Write a Bash script that:
...
**Files -  `101-manage_my_process`, and `manage_my_process`:**
